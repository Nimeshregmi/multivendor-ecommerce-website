      ...
      <li className="hidden lg:block">
        <form action="https://formbold.com/s/unique_form_id" method="POST">
          <div className="relative w-full max-w-[300px]">
            <button className="absolute left-5 top-1/2 -translate-y-1/2 text-ddark hover:text-dprimary dark:text-ddark-6 dark:hover:text-dprimary">
              <svg
            ...
            <input
              type="text"
              placeholder="Search"
              className="w-full rounded-full border border-stroke bg-gray-2 py-3 pl-14 pr-5 text-ddark focus:border-dprimary focus:outline-none dark:border-ddark-4 dark:bg-ddark-3 dark:text-white dark:focus:border-dprimary xl:w-[300px]"
            />
          </div>
        </form>
      </li>
