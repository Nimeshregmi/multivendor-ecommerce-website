...
export function XBlogArticle() {
  return (
    <div className="w-80">
      ...
      >
        <div className="group relative rounded-t-md h-full overflow-hidden rounded-2xl border border-zinc-100 dark:bg-black bg-white transition duration-200 hover:shadow-xl">
          ...
          <div className=" p-4">
            ...
            <h2 className="my-4 text-sm font-normal ">
              {blogContent.description}
            </h2>
            <div className="mt-10 flex flex-row items-center justify-between">
              <span className="text-sm ">{blogContent.date}</span>
              <div className="relative z-10 block rounded-xl bg-black dark:bg-white px-2 cursor-pointer py-2 text-xs font-bold text-white dark:text-black">
                Read More
              </div>
            </div>
          </div>
...
const TitleComponent = ({
  ...
  <div className="flex items-center space-x-2">
    <img
      ...
      width="20"
      alt="thumbnail"
      className="rounded-full border-2 border-white dark:text-white text-black"
    />
